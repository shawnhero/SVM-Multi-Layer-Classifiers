...
def first_train():
	...
	multi_svm.train(features[is_train==1], attributes[0:4,is_train==1], c_values,  get_interval=5)


def first_predict(prediction_save_name="politics_predicts"):
	...
	multi_svm.predict(features, save=True, savename=prediction_savename)
...
if __name__ == "__main__":
	first_train()
	first_predict(prediction_save_name="politics_few_predicts")
	second_train_and_test(attributes_load_name="politics_few_predicts")
